...
app = Flask(__name__)
model=joblib.load(r"C:\Users\nagar\Desktop\datascience\MAY\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
...
@app.route('/')
def home():
    return render_template('C:\Users\nagar\Desktop\datascience\MAY\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\templates\index.html')
